...
exports.IpInfoVendor = void 0;
const BaseIpVendor_1 = require("../BaseIpVendor");
class IpInfoVendor extends BaseIpVendor_1.BaseIpVendor {
    constructor() {
        super(...arguments);
        this.name = "ipinfo";
        this.baseUrl = "https://ipinfo.io";
        this.countryKeyName = "country";
        this.isCountryCodeReturned = true;
    }
...
exports.IpInfoVendor = IpInfoVendor;
